...
class PhoneNumbersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phone_number" do
    assert_difference('PhoneNumber.count') do
      post phone_numbers_url, params: { phone_number: { comments: @phone_number.comments, date: @phone_number.date, integer: @phone_number.integer, location: @phone_number.location, phonenumber: @phone_number.phonenumber, string: @phone_number.string } }
    end
  ...
  test "should update phone_number" do
    patch phone_number_url(@phone_number), params: { phone_number: { comments: @phone_number.comments, date: @phone_number.date, integer: @phone_number.integer, location: @phone_number.location, phonenumber: @phone_number.phonenumber, string: @phone_number.string } }
